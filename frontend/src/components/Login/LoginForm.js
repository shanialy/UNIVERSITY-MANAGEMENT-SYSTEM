    ...
    return (
        <div>
            <form className="login-form-container" onSubmit={handleSubmit(onSubmit)}>
               <h1>UNIVERSITY OF PEERU LASHARI</h1>
                <h1><b>LOG IN</b></h1>
                <label for="fname">CNIC</label>
                <input type="text" name="admin_cnic" placeholder="CNIC NUMBER"
                ...
                <Link to="/student-registration-portal">
                    <button className='btn btn-warning' style={{ margin: "2% 0", padding: "2%", color: "white", border: "none", background: "blue", cursor: "pointer", fontSize: "15px", width: "100%" }}>
